...
([
  ...
  function(module, exports, __webpack_require__) {
    ...
    var createVideoIncon = function createVideoIncon() {
	  ...
	  var len = $videoImg.length;
      for (var i = 0, i &lt;= len; i++) { addmask($videoimg[i]); } }; var render="function" render(res) ultmpl ; for (var j="0," len2="res.list.length;" &lt; len2; j++) data="res.list[j].arr;" litmpl i="0," len="data.link.length;" 需要修改https: raw.githubusercontent.com 你的github名 你的github仓库名 master min_photos 即可 minsrc="https://raw.githubusercontent.com/LittleSogo/img/master/min_photos/" + data.link[i]; src="https://raw.githubusercontent.com/LittleSogo/img/master/photos/" type="data.type[i];" target="src" (type="==" 'video' ? '.mp4' : '.jpg'); '" itemprop="contentUrl" data-size="1080x1080" data-type="' + type + '" data-target="' + src + '"&gt;\
